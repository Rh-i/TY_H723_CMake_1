...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  */
    ...
    */
    ...
    hdma_uart7_tx.Init.FIFOThreshold = DMA_FIFO_THRESHOLD_HALFFULL;
  ...
  */
    ...
    */
    ...
    /* UART9_TX Init */
    hdma_uart9_tx.Instance = DMA2_Stream2;
    ...
    hdma_uart9_tx.Init.FIFOThreshold = DMA_FIFO_THRESHOLD_HALFFULL;
  ...
  */
    ...
    */
    ...
    hdma_usart10_tx.Init.FIFOThreshold = DMA_FIFO_THRESHOLD_HALFFULL;
